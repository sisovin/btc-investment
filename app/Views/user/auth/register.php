...
<head>
    ...
    <meta name="description" content="Register for BTC Investment - Start your cryptocurrency investment journey">
    <meta name="keywords" content="bitcoin, crypto, investment, register, signup">
    ...
    <title><?php echo $title ?? 'Register - BTC Investment'; ?></title>
</head>
<body class="h-full flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
    <div class="w-full max-w-md space-y-8">
        ...
        <div class="text-center">
            ...
            <p class="text-blue-100">Create your account and start investing</p>
        </div>

        <!-- Register Form -->
        <div class="auth-card rounded-2xl p-8 shadow-2xl">
            <form method="POST" action="<?php echo url('/register'); ?>" class="space-y-6">
                <?php echo csrf_field(); ?>
                ...
                <div class="flex items-start">
                    ...
                    <div class="ml-3 text-sm">
                        <label for="terms" class="text-gray-700">
                            I agree to the
                            <a href="<?php echo url('/terms'); ?>" class="text-blue-600 hover:text-blue-500 font-medium">Terms of Service</a>
                            and
                            <a href="<?php echo url('/privacy'); ?>" class="text-blue-600 hover:text-blue-500 font-medium">Privacy Policy</a>
                        </label>
                    </div>
                </div>
                ...
                <div class="flex items-center">
                    ...
                    <label for="newsletter" class="ml-2 block text-sm text-gray-700">
                        Subscribe to our newsletter for investment tips and updates
                    </label>
                </div>
            ...
            <div class="mt-6 text-center">
                <p class="text-sm text-gray-600">
                    ...
                    <a href="<?php echo url('/login'); ?>" class="font-medium text-blue-600 hover:text-blue-500 transition duration-200">
                        Sign in here
                    </a>
                </p>
            </div>
