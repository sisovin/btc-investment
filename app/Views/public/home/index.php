    ...
    <div class="relative max-w-7xl mx-auto px-4 py-24 sm:px-6 lg:px-8">
        <div class="text-center">
            ...
            <div class="flex flex-col sm:flex-row gap-4 justify-center">
                <a href="{{ url('/register') }}" class="bg-yellow-500 hover:bg-yellow-600 text-black font-bold py-3 px-8 rounded-lg text-lg transition duration-300">
                    Start Investing Now
                </a>
                <a href="{{ url('/plans') }}" class="bg-white bg-opacity-20 hover:bg-opacity-30 border-2 border-white text-white font-bold py-3 px-8 rounded-lg text-lg transition duration-300">
...
<section class="py-16">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-8 mb-8">
            @if(!empty($plans))
                ...
                <div class="bg-white rounded-lg shadow-lg p-8 text-center border border-gray-200 hover:shadow-xl transition duration-300">
                    ...
                    <div class="text-3xl font-bold text-blue-600 mb-2">{{ $plan['interest_rate'] ?? '0' }}%</div>
                    <div class="text-gray-600 mb-4">Daily Return</div>
                    <div class="text-sm text-gray-500 mb-6">
                        Min: ${{ number_format($plan['min_amount'] ?? 0) }} -
                        Max: ${{ $plan['max_amount'] ? number_format($plan['max_amount']) : 'Unlimited' }}
                    </div>
                    <a href="{{ url('/register') }}" class="bg-blue-600 hover:bg-blue-700 text-white font-bold py-3 px-6 rounded-lg transition duration-300">
                        Choose Plan
                    </a>
                </div>
                @endforeach
        ...
        <div class="text-center">
            <a href="{{ url('/plans') }}" class="bg-gray-800 hover:bg-gray-900 text-white font-bold py-3 px-8 rounded-lg text-lg transition duration-300">
                View All Plans
            </a>
        </div>
    </div>
...
<section class="py-16 bg-blue-600 text-white">
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        <div class="flex flex-col sm:flex-row gap-4 justify-center">
            <a href="{{ url('/register') }}" class="bg-yellow-500 hover:bg-yellow-600 text-black font-bold py-4 px-8 rounded-lg text-lg transition duration-300">
                Create Free Account
            </a>
            <a href="{{ url('/contact') }}" class="bg-white bg-opacity-20 hover:bg-opacity-30 border-2 border-white text-white font-bold py-4 px-8 rounded-lg text-lg transition duration-300">
                Contact Support
            </a>
        </div>
    </div>
